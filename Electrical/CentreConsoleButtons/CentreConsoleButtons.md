...
> - [Ender 3 V3](../../Credits.md#software--hardware) (3D printer):
>   - Material used: ASA
>   - Supports: yes
>   - Notes: Printed vertically for decreased printing lines
...
> In the interest of this projects vision, the published STL file is stored on this website as a backup [HERE](./centrepanel.stl). *Last synced - 28/08/26*
{: .block-note}

![3D printed fascia](./3d-print-cover.jpg)

> Picture of a printed fascia using the materials and tools listed above. This is representative of the models state as of 28/08/26