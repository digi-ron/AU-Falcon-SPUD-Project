...
The only known exception to this is wagon body Falcons, which have 5.25" round speakers in the rear
...
> Lack of images and information in this section due to project only involving Sedan
{: .block-note}
...
1. Undo the single 10mm bolt at the bottom of the rear seat bolster, and then lift the bolster to disengage it from a single clip in the top of the assembly

    > Theoretically the top clip could be disengaged without unbolting the bolster allowing you to push it away from the C-pillar enough for the rest of this procedure, but this is not recommended due to the risk of damage to the bolster plastic clip
    {: .block-note}

    ![Bolster Bolt](./wagon-bolster-bolt.jpg)
    ![Bolster Clip](./wagon-bolster-top-clip.jpg)
    > Picture of the bottom bolster bolt and the clip and its original location in the top of the bolster respectively

1. Remove the speaker cover by gently unclipping it from the C-Pillar trim

    > This is simply done as a precaution against breaking, as the covers are thin and can become brittle over time
    {: .block-note}

1. Remove the plastic C-Pillar upper trim. Note that this is held in with a screw in addition to clips along the C-Pillar itself

    > Without removing the bottom mount for the rear seatbelts, the C-Pillar trim cannot be removed completely. Simply slide it down the seatbelt out of the way for this procedure
    {: .block-note}

    ![C Pillar Screw Location](./wagon-c-pillar-screw.jpg)
    > Picture of the screw in the C-Pillar

1. Remove all plastic tabs and screws holding the cloth panelling on the side of the car you are working on. This will involve at least the following:
    - 1 plastic tab near the speaker itself

        ![Speaker Plastic Tab](./wagon-speaker-tab.jpg)
        > Picture of the plastic tab to the side of the speaker

    - 1 plastic tab on the boot end of the panel

        ![Boot Plastic Tab](./wagon-boot-tab.jpg)
        > Picture of the plastic tab at the rear of the panel, in line with the interior edge of the tailgate

    - 2 Torx T27 screws, holding in the Cargo Net clips. Once removed the clips themselves can be pulled out with moderate force

        > The removal of these is not strictly required if inconvenient, however this prevents damage to the panel on removal. If you choose to leave them, be careful of a small lip around the base of each clip
        {: .block-note}

        ![Wagon Cargo Clip](./wagon-cargo-clip.jpg)
        > Picture of one of the cargo clips in the boot side panel
    - (If drivers side) 1 emergency jack & wheel tool compartment door

        > This is optional to remove, however removal of this prevents any possibility of damage to the plastic knob on the door itself
        {: .block-note}
...
1. Remove the 4 screws holding in the speakers and remove
    ...
    > Picture of the screw locations for the rear speaker
