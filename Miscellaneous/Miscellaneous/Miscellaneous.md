...
- Side indicators in the front quarter panels cannot be retrofitted to use B-Series sequential indicators such as those available through [Ozeparts](../../Credits.md#sources) as the indicators are too close to the front seam for the front doors. They also have different clips making OEM housings non-viable.
