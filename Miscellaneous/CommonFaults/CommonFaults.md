...
| Welch Plugs | All | All | If the cooling system sees a lot of water instead of coolant over it's life, the welch plugs have an increased chance of leaking, requiring replacement. Green premix coolant appears to be the most convenient option which does not cause this issue to happen prematurely |
{: .sortable-table}