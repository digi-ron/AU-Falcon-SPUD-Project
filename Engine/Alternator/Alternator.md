...
1. Reaching behind the power steering reservoir to the alternator rear, undo the 10mm nut holding the main electrical connection from the alternator to the rest of the vehicle wiring loom
1. Disconnect the alternator plug, which is:
    - S1 - on the top driver side of the alternator, facing upwards
    - S2-3 - on the bottom middle of the alternator, facing downwards
